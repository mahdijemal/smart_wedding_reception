...
public:
    ...
    void setupUi(QDialog *dialogclient)
    {
        ...
        dialogclient->resize(654, 507);
        dialogclient->setStyleSheet(QLatin1String("QLabel {\n"
"font-weight: bold;\n"
"font-size: 10px;\n"
"}\n"
"QLineEdit {\n"
...
""));
        logout_2 = new QPushButton(dialogclient);
        logout_2->setObjectName(QStringLiteral("logout_2"));
        logout_2->setGeometry(QRect(620, 10, 21, 21));
        ...
        label_13 = new QLabel(dialogclient);
        label_13->setObjectName(QStringLiteral("label_13"));
        label_13->setGeometry(QRect(220, 10, 151, 31));
        label_13->setStyleSheet(QStringLiteral("border-image: url(:/image/image/Capture53.png);"));
        logout = new QPushButton(dialogclient);
        logout->setObjectName(QStringLiteral("logout"));
        logout->setGeometry(QRect(550, 10, 71, 21));
        ...
        tabWidget->setGeometry(QRect(0, 60, 631, 401));
        create = new QWidget();
        create->setObjectName(QStringLiteral("create"));
        ajouter = new QPushButton(create);
        ajouter->setObjectName(QStringLiteral("ajouter"));
        ajouter->setGeometry(QRect(180, 320, 291, 41));
        ...
        id_asc->setGeometry(QRect(-60, 30, 201, 41));
...
"text-decoration: none; }"));
        ...
        id_desc->setGeometry(QRect(20, 30, 121, 41));
...
"text-decoration: none; }"));
        ...
        num_asc->setGeometry(QRect(120, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        des_asc->setGeometry(QRect(220, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        montant_asc->setGeometry(QRect(330, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        type_asc->setGeometry(QRect(460, 30, 81, 41));
...
"text-decoration: none; }"));
        ...
        type_desc->setGeometry(QRect(460, 30, 91, 41));
...
"text-decoration: none; }"));
        ...
        type_asc_2->setGeometry(QRect(530, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        type_desc_2->setGeometry(QRect(530, 30, 131, 41));
...
"text-decoration: none; }"));
        ...
        num_desc->setGeometry(QRect(120, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        des_desc->setGeometry(QRect(220, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        montant_desc->setGeometry(QRect(330, 30, 101, 41));
...
"text-decoration: none; }"));
        ...
        idEdit->setGeometry(QRect(210, 70, 161, 21));
        idEdit->setStyleSheet(QLatin1String("\n"
"border-image: url(:/image/image/Capture5.png);"));
        edit = new QPushButton(update);
        edit->setObjectName(QStringLiteral("edit"));
        edit->setGeometry(QRect(390, 70, 91, 21));
        ...
        label_3->setGeometry(QRect(170, 60, 31, 41));
        edit_idc = new QLineEdit(update);
        edit_idc->setObjectName(QStringLiteral("edit_idc"));
        edit_idc->setGeometry(QRect(110, 140, 131, 20));
        edit_idc->setStyleSheet(QLatin1String("\n"
"border-image: url(:/image/image/Capture5.png);"));
        editDate = new QLineEdit(update);
        editDate->setObjectName(QStringLiteral("editDate"));
        editDate->setGeometry(QRect(410, 140, 141, 20));
        editDate->setStyleSheet(QLatin1String("\n"
"border-image: url(:/image/image/Capture5.png);"));
        edit_nom = new QLineEdit(update);
        edit_nom->setObjectName(QStringLiteral("edit_nom"));
        edit_nom->setGeometry(QRect(110, 230, 131, 20));
        edit_nom->setStyleSheet(QLatin1String("\n"
"border-image: url(:/image/image/Capture5.png);"));
        edit_prenom = new QLineEdit(update);
        edit_prenom->setObjectName(QStringLiteral("edit_prenom"));
        edit_prenom->setGeometry(QRect(410, 230, 141, 20));
        edit_prenom->setStyleSheet(QLatin1String("\n"
"border-image: url(:/image/image/Capture5.png);"));
        editOk = new QPushButton(update);
        editOk->setObjectName(QStringLiteral("editOk"));
        editOk->setGeometry(QRect(150, 340, 311, 31));
        ...
        label_6->setGeometry(QRect(40, 230, 61, 16));
        label_7 = new QLabel(update);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(310, 230, 81, 21));
        ...
        delete_btn->setGeometry(QRect(230, 100, 161, 31));
    ...
    void retranslateUi(QDialog *dialogclient)
    {
        ...
        ajouter->setText(QApplication::translate("dialogclient", "Add", Q_NULLPTR));
        label_8->setText(QApplication::translate("dialogclient", "CLIENT ID", Q_NULLPTR));
        label_9->setText(QApplication::translate("dialogclient", "ID CLIENT :", Q_NULLPTR));
        label_10->setText(QApplication::translate("dialogclient", "DATE", Q_NULLPTR));
        label_11->setText(QApplication::translate("dialogclient", "NOM", Q_NULLPTR));
        label_12->setText(QApplication::translate("dialogclient", "PRENOM", Q_NULLPTR));
        label->setText(QApplication::translate("dialogclient", "Type of wedding", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(create), QApplication::translate("dialogclient", "CREATE", Q_NULLPTR));
        id_asc->setText(QApplication::translate("dialogclient", "                                      ^", Q_NULLPTR));
        id_desc->setText(QApplication::translate("dialogclient", "           v", Q_NULLPTR));
        num_asc->setText(QApplication::translate("dialogclient", "                            ^", Q_NULLPTR));
        des_asc->setText(QApplication::translate("dialogclient", "                            ^", Q_NULLPTR));
        montant_asc->setText(QApplication::translate("dialogclient", "                            ^", Q_NULLPTR));
        type_asc->setText(QApplication::translate("dialogclient", "     ^", Q_NULLPTR));
        type_desc->setText(QApplication::translate("dialogclient", "  v", Q_NULLPTR));
        pushButton->setText(QApplication::translate("dialogclient", "PRINT", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("dialogclient", "Delete", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("dialogclient", "Modify", Q_NULLPTR));
        type_asc_2->setText(QApplication::translate("dialogclient", "              ^", Q_NULLPTR));
        type_desc_2->setText(QApplication::translate("dialogclient", "    v", Q_NULLPTR));
        ...
        label_14->setText(QApplication::translate("dialogclient", "NEW TYPE DE FETE :", Q_NULLPTR));
        edit_tfete->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(update), QApplication::translate("dialogclient", "UPDATE", Q_NULLPTR));
        delete_btn->setText(QApplication::translate("dialogclient", "Delete", Q_NULLPTR));
        label_2->setText(QApplication::translate("dialogclient", "ID :", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(deletee), QApplication::translate("dialogclient", "DELETE", Q_NULLPTR));
        previousmodule->setText(QApplication::translate("dialogclient", "\342\206\220", Q_NULLPTR));
        back->setText(QApplication::translate("dialogclient", "MAINMENU", Q_NULLPTR));
        nextcrud->setText(QApplication::translate("dialogclient", "\342\206\222", Q_NULLPTR));
    } // retranslateUi

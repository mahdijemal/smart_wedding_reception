/********************************************************************************
** Form generated from reading UI file 'dialogsalle.ui'
**
...
#ifndef UI_DIALOGSALLE_H
#define UI_DIALOGSALLE_H
...
public:
    ...
    void setupUi(QDialog *dialogsalle)
    {
        if (dialogsalle->objectName().isEmpty())
            dialogsalle->setObjectName(QStringLiteral("dialogsalle"));
        dialogsalle->resize(640, 512);
        logout = new QPushButton(dialogsalle);
        ...
        previousmodule_2 = new QPushButton(dialogsalle);
        ...
        close = new QPushButton(dialogsalle);
        ...
        tabWidget = new QTabWidget(dialogsalle);
        ...
        label_10->setGeometry(QRect(100, 120, 71, 20));
        label_11 = new QLabel(create);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(100, 160, 61, 20));
        label_12 = new QLabel(create);
        label_12->setObjectName(QStringLiteral("label_12"));
        label_12->setGeometry(QRect(126, 200, 41, 20));
...
"text-decoration: none; }"));
        ...
        nextmodule = new QPushButton(dialogsalle);
        ...
        nextcrud = new QPushButton(dialogsalle);
        ...
        prevcrud = new QPushButton(dialogsalle);
        ...
        back = new QPushButton(dialogsalle);
        ...
        label_13 = new QLabel(dialogsalle);
        ...
        retranslateUi(dialogsalle);

        tabWidget->setCurrentIndex(3);


        QMetaObject::connectSlotsByName(dialogsalle);
    } // setupUi

    void retranslateUi(QDialog *dialogsalle)
    {
        dialogsalle->setWindowTitle(QApplication::translate("dialogsalle", "Dialog", Q_NULLPTR));
        logout->setText(QApplication::translate("dialogsalle", "LOGOUT", Q_NULLPTR));
        previousmodule_2->setText(QApplication::translate("dialogsalle", "\342\206\220", Q_NULLPTR));
        close->setText(QApplication::translate("dialogsalle", "X", Q_NULLPTR));
        ajouter->setText(QApplication::translate("dialogsalle", "Add", Q_NULLPTR));
        label_8->setText(QApplication::translate("dialogsalle", "id_salle", Q_NULLPTR));
        label_9->setText(QApplication::translate("dialogsalle", "nbr_tab_rd", Q_NULLPTR));
        label_10->setText(QApplication::translate("dialogsalle", "nbr_tab_rect", Q_NULLPTR));
        label_11->setText(QApplication::translate("dialogsalle", "nbr_tab_ov", Q_NULLPTR));
        label_12->setText(QApplication::translate("dialogsalle", "nbr_chs", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(create), QApplication::translate("dialogsalle", "CREATE", Q_NULLPTR));
        id_asc->setText(QApplication::translate("dialogsalle", "           ^", Q_NULLPTR));
        id_desc->setText(QApplication::translate("dialogsalle", "           v", Q_NULLPTR));
        num_asc->setText(QApplication::translate("dialogsalle", "           ^", Q_NULLPTR));
        num_desc->setText(QApplication::translate("dialogsalle", "           v", Q_NULLPTR));
        des_asc->setText(QApplication::translate("dialogsalle", "           ^", Q_NULLPTR));
        des_desc->setText(QApplication::translate("dialogsalle", "           v", Q_NULLPTR));
        montant_asc->setText(QApplication::translate("dialogsalle", "           v", Q_NULLPTR));
        montant_desc->setText(QApplication::translate("dialogsalle", "           ^", Q_NULLPTR));
        type_asc->setText(QApplication::translate("dialogsalle", "  ^", Q_NULLPTR));
        type_desc->setText(QApplication::translate("dialogsalle", "  v", Q_NULLPTR));
        previousmodule->setText(QApplication::translate("dialogsalle", "\342\206\220", Q_NULLPTR));
        pushButton->setText(QApplication::translate("dialogsalle", "PRINT", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("dialogsalle", "Delete", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("dialogsalle", "Modify", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(read), QApplication::translate("dialogsalle", "READ", Q_NULLPTR));
        edit->setText(QApplication::translate("dialogsalle", "Select", Q_NULLPTR));
        label_3->setText(QApplication::translate("dialogsalle", "ID :", Q_NULLPTR));
        editOk->setText(QApplication::translate("dialogsalle", "Save", Q_NULLPTR));
        label_4->setText(QApplication::translate("dialogsalle", "Nouveau Montant", Q_NULLPTR));
        label_5->setText(QApplication::translate("dialogsalle", "Nouveau Nom", Q_NULLPTR));
        label_6->setText(QApplication::translate("dialogsalle", "Nouveau Num", Q_NULLPTR));
        label_7->setText(QApplication::translate("dialogsalle", "Nouveau Type", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(update), QApplication::translate("dialogsalle", "UPDATE", Q_NULLPTR));
        delete_btn->setText(QApplication::translate("dialogsalle", "Delete", Q_NULLPTR));
        label_2->setText(QApplication::translate("dialogsalle", "ID :", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(deletee), QApplication::translate("dialogsalle", "DELETE", Q_NULLPTR));
        nextmodule->setText(QApplication::translate("dialogsalle", "\342\206\222", Q_NULLPTR));
        nextcrud->setText(QApplication::translate("dialogsalle", "\342\206\222", Q_NULLPTR));
        prevcrud->setText(QApplication::translate("dialogsalle", "\342\206\220", Q_NULLPTR));
        back->setText(QApplication::translate("dialogsalle", "MAINMENU", Q_NULLPTR));
        label_13->setText(QApplication::translate("dialogsalle", "      SALLE", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class dialogsalle: public Ui_dialogsalle {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DIALOGSALLE_H
